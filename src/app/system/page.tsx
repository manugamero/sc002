      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        >
          <h2 className="text-xl font-semibold mb-4 flex items-center space-x-2">
            ...
            <span>Elementos de Navegación</span>
          </h2>
          ...
          <div className="space-y-6">
            ...
            <div>
              ...
              <nav className="flex items-center space-x-2 text-sm">
                ...
                <span className="text-gray-400">/</span>
                <span className="text-gray-900 font-medium">Sistema</span>
              </nav>
            </div>
            ...
            <div>
              ...
              <div className="flex items-center space-x-2">
                ...
                <button className="px-3 py-2 text-sm bg-blue-500 text-white rounded-lg">1</button>
            ...
            <div>
              ...
              <div className="mt-4 p-4 bg-gray-50 rounded-lg">
                <p className="text-sm text-gray-600">Contenido de la pestaña activa</p>
              </div>
            </div>
          </div>
        </motion.div>
        ...
        >
          <h2 className="text-xl font-semibold mb-4 flex items-center space-x-2">
            ...
            <span>Modales y Overlays</span>
          </h2>
          
          <div className="space-y-6">
            {/* Modal Example */}
            <div>
              <h3 className="text-lg font-medium mb-3">Modal de Ejemplo</h3>
              <div className="relative bg-white border border-gray-200 rounded-lg shadow-lg p-6 max-w-md">
            ...
            {/* Toast Notifications */}
            <div>
              <h3 className="text-lg font-medium mb-3">Notificaciones Toast</h3>
              <div className="space-y-3">
                <div className="bg-green-50 border border-green-200 rounded-lg p-4 flex items-center space-x-3">
                  <CheckCircle className="w-5 h-5 text-green-500" />
                  <span className="text-sm text-green-800">Guardado exitosamente</span>
                ...
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4 flex items-center space-x-3">
                  <TrendingUp className="w-5 h-5 text-blue-500" />
                  <span className="text-sm text-blue-800">Nuevo mensaje recibido</span>
        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {/* Stats Cards */}
            <div>
              <h3 className="text-lg font-medium mb-3">Tarjetas de Estadísticas</h3>
              <div className="grid grid-cols-2 gap-4">
                <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                  ...
                  <p className="text-xs text-blue-600 mt-2">+12% desde el mes pasado</p>
                </div>
                <div className="bg-green-50 border border-green-200 rounded-lg p-4">
                  <div className="flex items-center justify-between">
                    <div>
                  ...
                  <p className="text-xs text-green-600 mt-2">+8% desde el mes pasado</p>
                </div>
              </div>
            </div>
            ...
            {/* Simple Chart */}
            <div>
              <h3 className="text-lg font-medium mb-3">Gráfico Simple</h3>
